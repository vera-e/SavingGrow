...
public class Tab1Income extends Fragment {
    ...
    //TODO
//    private Button CategoryMultiplechoice;
...
//
//        CategoryMultiplechoice = (Button)findViewById(R.id.btchooseCategory);
//        relativeLayout = (RelativeLayout) findViewById ()
//
//        CategoryMultiplechoice.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                layoutInflater = (LayoutInflater) getApplicationContext().getSystemService(LAYOUT_INFLATER_SERVICE);
//                ViewGroup container = (ViewGroup) layoutInflater.inflate(R.layout.CategoryMultiplechoice,null);
//
//                popupWindow = new PopupWindow(container,1000,500,true);
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // This is Context related
        final View rootView = inflater.inflate(R.layout.fragment_income, container, false);


        // This is Date picker related
        // Text will auto set to TODAY date
        // Click and calendar will popup
        ...
        // Return Context to MainFragment
        return rootView;
    }
